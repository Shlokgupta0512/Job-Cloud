...
const MyApplications = () => {
  ...
  useEffect(() => {
    try {
      if (user && user.role === "Employer") {
        axios
          .get(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:4000"}/api/v1/application/employer/getall`, {
        ...
        axios
          .get(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:4000"}/api/v1/application/jobseeker/getall`, {
            withCredentials: true,
          })
          .then((res) => {
            setApplications(res.data.applications);
  ...
  const deleteApplication = (id) => {
    try {
      axios
        .delete(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:4000"}/api/v1/application/delete/${id}`, {
          withCredentials: true,
        })
        .then((res) => {
